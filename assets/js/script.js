...
function intro (id) {
	...
	for (var i = 0; i < dot.length; i++) {
		dot[i].src = "assets/images/change-slide-uncheck.png";
	}
	dot[introID-1].src = "assets/images/change-slide-check.png";
}
function introCheck(id) {
	...
	dot[id-1].src = "assets/images/change-slide-check.png";
...
function place (id) {
	...
	for (var i = 0; i < placeMax; i++) {
		place[i].style.backgroundImage = "url('assets/images/favourite-tour-"+ n.toString() +".jpg')";
		n++;
		if (n > placeMax) n = 1;
		if (n < 1) n = placeMax;
	}
...
function customer (id) {
	...
	for (var i = 0; i < customerMax; i++) {
		customer[i].style.backgroundImage = "url('assets/images/customer-"+ n.toString() +".jpg')";
		n++;
...
function brand (id) {
	...
	for (var i = 0; i < brandMax; i++) {
		brand[i].src = "assets/images/brand-"+ n.toString() +".jpg";
		n++;
		if (n > brandMax) n = 1;
		if (n < 1) n = brandMax;
	}
